...
@section('title')
    Tipos de Tributos Registrados en el Sistema
@endsection
...
@section('content')
    @include('admin.parametros.responiva.editar')
    @include('admin.parametros.responiva.confirmar')
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            <div class="page-title">
              Tipo de Tributo: {{ $responiva->nombre }}</div>
        </div>        
        <div class="page-header pull-right">
            <div class="page-toolbar">
                ...
                <a data-toggle="tooltip" data-placement="bottom" href="{{ route('admin.responiva.index') }}" title="Volver a los Tipos de Registros Tributarios"  class="btn btn-blue"> <span class="fa fa-arrow-circle-o-left" aria-hidden="true"></span> Volver</a>
            </div>
        </div>
                                                    ...
                                                    <table class="table table-striped table-hover">
                                                        <tbody> 
                                                            <tr>
                                                                ...
                                                                <td><h4>{{ $responiva->nombre }}</h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td><h4 class="box-heading">Porcentaje de IVA:</h4></td>
                                                                <td><h4>{{ $responiva->iva }}%</h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td><h4 class="box-heading">Tipo de Factura:</h4></td>
                                                                <td><h4>{{ $responiva->factura }}</h4></td>
                                                            </tr>
                                                            <tr>
                                                                <td><h4 class="box-heading">Descripcion:</h4></td>
                                                                <td><h4>{{ $responiva->descripcion }}</h4></td>
                                                            </tr>
