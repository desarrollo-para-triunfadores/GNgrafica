...
<div class="form-group hide"><label class="col-sm-3 control-label">Caja</label>
    <div class="col-sm-9 controls">
        <div class="row">
            <div class="col-xs-12">
                <div class="input-icon right">
                    <i class="fa fa-pencil"></i>
                    {!! Form::text('caja_id', $caja->id, ['class' => 'form-control']) !!}                                
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-9 controls">
        <div class="row">
            <div class="col-xs-12">
                <div class="input-icon right">
                    <i class="fa fa-pencil"></i>
                    {!! Form::text('concepto', null, ['class' => 'form-control', 'require']) !!}                                
                </div>
            </div>
        </div>
    </div>
