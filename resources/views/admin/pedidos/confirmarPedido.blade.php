        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="note note-info">
                  ...
                  <p>Está por realizar la registración de un nuevo pedido. De encontrarse seguro puede proseguir presionando el boton "Registrar".</p>
              </div>

            </div>
            <div class="modal-footer">
              <button type="button" data-dismiss="modal" class="btn btn-white"> Cerrar</button>
              <button type="button" data-dismiss="modal" class="btn btn btn-success" onclick="enviarPedido(false, false);"> Registrar pedido</button>
   </div>
        </div>
    </div>
</div>
